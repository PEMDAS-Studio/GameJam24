...
@onready var credits_button = $Credits_Button as Button
...
@onready var credits_screen = $Credits_Screen as CreditsScreen
@onready var settings = load("res://main_menu/Settings Menu/settings_menu.tscn") as PackedScene
@onready var credits = load("res://main_menu/credits_screen.tscn") as PackedScene
